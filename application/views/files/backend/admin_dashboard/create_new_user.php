<div class="row register-form">
    <div class="col-md-12">
      <section>      
        <h3 class="text-center"><span>Sign Up</span> </h3>
        <hr>

          <?=form_open($home_url.'dashboard/create',array('class'=>'form-horizontal','id'=>'signup','enctype'=>'multipart/form-data'))?>  
        ...
        <div class="form-group">
          ...
          <div class="col-md-5 col-sm-8">
            <div class="input-group">
              ...
              <input type="password" class="form-control" name="password" id="password" maxlength="16" placeholder="Choose password (6-16 chars)">
           </div>   
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-md-5 col-sm-8">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
              <input type="password" class="form-control" name="cpassword" id="cpassword" maxlength="16" placeholder="Confirm your password">
            </div>  
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-md-8 col-sm-9">
            <div class="row">
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="first_name" id="mem_first_name" placeholder="First name">
                </div>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="last_name" id="mem_last_name" placeholder="Last name">
                </div>
            </div>
          </div>
        </div>
        ...
        */ ?>
        <div class="form-group">
          ...
          <div class="col-md-5 col-sm-8">
            ...
            <input type="text" class="form-control" name="mobile" id="mobile" placeholder="Enter your Primary contact no.">
            </div>
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-sm-3">Store No. <br>
          <small>(if any)</small></label>
          <div class="col-md-5 col-sm-8">
            <input type="text" class="form-control" name="store_num" id="store_num" placeholder="Store no (if any)">
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-md-5 col-sm-8">
            <div class="input-group"> <span class="input-group-addon" id="file_upload"><i class="glyphicon glyphicon-upload"></i></span>
              <input type="file" name="profile_pic" id="profile_pic" class="form-control upload" placeholder="" aria-describedby="file_upload">
            </div>
          </div>
        </div>        
        <div class="form-group">
          <div class="col-xs-offset-3 col-md-8 col-sm-9"><span class="text-muted"><span class="label label-danger">Note:-</span> You are creating a new user account</span> </div>
        </div>
        <div class="form-group">
          <div class="col-xs-offset-3 col-xs-10">
            <input name="Submit" type="submit" value="Create" class="btn btn-primary" style="width: 200px;">
          </div>
        </div>
      <?=form_close()?>
